    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div style=" background-color:#1466C3; color:#fff"  class="bg text-white p-3 mb-3 rounded-top">
                <h2 class="text-center animate__animated animate__backInDown">Datos de Puesto</h2>
            </div>
           
                <form class="formulario-aceptar" action="{{ route('puesto.guardar')}}" method="POST" class="shadow p-3 mb-5 bg-white rounded" style="animation: fadeInUp">
                 @csrf
                ...
                <div class="form-group row animate__animated animate__backInDown">
                    ...
                    <div class="col-sm-9">
                    <input type="nombre" class="form-control input-animation" id="nombre" name="nombre"  value="{{$puesto->nombre =='' ?  old('nombre') :$puesto->nombre}}" >
                     <!--mostrar el error de validacion -->
                     @error('nombre')
                       <small style="color: red" >{{$message}}</small>
                        @enderror   
                ...
                <div class="text-center">
                    <button id="saberBtn"  class="btn animate__animated animate__bounce "  style=" background-color:#1466C3; color:#fff" >Aceptar</button>
                </div>
                </form>
            </div>
        </div>
