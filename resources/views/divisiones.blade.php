...
<center>
<div style=" width: 90%; background-color:#1466C3; color:#fff" id="tit"  class="bg text-white p-2 mb-4 rounded animate__fadeInDownBig">
                <h3 class="text-center animate__animated animate__backInDown">Divisiones</h3>
            </div>
            </center>
        
        <div class="">
            <table style="width: 90%;" id="table-data" class="animate__animated animate__bounce table table-bordered custom-table rounded">
                <thead style=" background-color:#1466C3; color:#fff; border-radius: 10px;">
                    <tr>
                        <th >Código</th>
                        <th>Nombre</th>
                ...
                <tbody style=" background-color:rgb(255,255,255)" >
                    ...
                    <tr>
                        <td class="animate__animated animate__backInDown animate__delay-1s">{{$division['codigo']}}</td>
                        <td class="animate__animated animate__backInDown animate__delay-1s">{{$division['nombre']}}</td>
                        <td>
                          
                            <a  href="{{route('nueva.division',['id' => $division['id']])}}" class="btn btn-success btn-sm rounded-8 animate__animated animate__backInDown animate__delay-1s">
                        ...
                        <td>
                                <a>
                                <form class="formulario-eliminar" action="{{route('division.borrar',['id' => $division['id']])}}" method="POST" >
                                    @csrf
                                    @method('DELETE')
                                    <button  class="btn btn-danger btn-sm animate__animated animate__backInDown animate__delay-1s ">
