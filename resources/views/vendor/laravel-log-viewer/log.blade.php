...
<head>
  ...
  <title>Laravel Registro de Logs</title>
  <link rel="stylesheet"
...
<div class="container-fluid">
  <div class="row">
    <div class="col sidebar mb-3">
      <h1><i class="fa fa-calendar" aria-hidden="true"></i> Laravel Registro de Logs </h1>
      <p class="text-muted"><i>Team PHP</i></p>
        ...
        <table id="table-log" class="table table-striped" data-ordering-index="{{ $standardFormat ? 2 : 0 }}">
          ...
          <tr>
            ...
            @else
              <th>Line number</th>
            @endif
            <th>Descripción de contenido y detalles</th>
          </tr>
          </thead>
          <tbody>
